...
This repository contains the MPLAB® Harmony 3 Graphics Application Package. Graphics applications are standalone applications which demonstrate of some of the capabilities of MPLAB® Harmony Graphics Suite for Microchip 32-bit SAM and PIC microprocessor devices.  Refer to
...
For more information on the tools, libraries and basic development with the MPLAB® Harmony Graphics Suite, please see the gfx repo also on github.
 ...
 - [MPLAB® Harmony 3 Graphics Repository](https://github.com/Microchip-MPLAB-Harmony/gfx_apps)
...
| doc        | Microsoft Compiled (CHM) and PDF Help documentation  |
